...
public abstract class BaseSource implements Source {
    ...
    public void addSource(Configuration config, Class<?> mapper, Method method) {
        ...
        SqlSource sqlSource = this.sqlSource(config, table, mappings);
    ...
    protected abstract SqlSource sqlSource(Configuration config, String table, List<Mapping> mappings);
